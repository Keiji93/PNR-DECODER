        ...
        bound.flights.forEach((flight) => {
          html += `
              <tr>
                ...
                <td align="left" style="text-align: left; padding: 16px 12px; border-bottom: 1px solid #e2e8f0; border-top: none; border-left: none; border-right: none; vertical-align: top; font-weight: bold; font-style: italic; color: #334155;">${flight.airline || '-'}</td>
                ...
                <td align="left" style="text-align: left; padding: 16px 12px; border-bottom: 1px solid #e2e8f0; border-top: none; border-left: none; border-right: none; vertical-align: top; color: #475569;">${flight.duration || '-'}</td>
